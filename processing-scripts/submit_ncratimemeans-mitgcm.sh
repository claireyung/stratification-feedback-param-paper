...
cd /g/data/x77/cy8964/mitgcm/archive 
...
find *cold* -maxdepth 0 -type d -exec bash -c "cd {}; bash /g/data/x77/cy8964/ISOMIP/param-paper-plots/ncra_timemeans-mitgcm.sh" \;
